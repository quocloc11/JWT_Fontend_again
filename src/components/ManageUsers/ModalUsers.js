                ...
                <Modal.Body>
                    <div className='content-body row'>
                        <div className='col-12 col-sm-6 form-group'>
                            ...
                            <input disabled={action === "CREATE" ? false : true} className={validInputs.email ? 'form-control' : 'form-control is-invalid'} typeof='email' value={userData.email}
                                onChange={(event) => handleOnchangeInput(event.target.value, "email")}
                            />
                        </div>
                        <div className='col-12 col-sm-6 form-group'>
                            <label>Phone number: (<span className='red'>*</span>)</label>
                            <input disabled={action === "CREATE" ? false : true} className={validInputs.phone ? 'form-control' : 'form-control is-invalid'} typeof='text' value={userData.phone}
